...
class COCOVisualizer():
    ...
    def visualize(self, img, tgt, caption=None, dpi=120, savedir=None, show_in_console=True):
        ...
        if savedir is not None:
            if caption is None:
                savename = '{}/{}-{}.png'.format(savedir,tgt['image_name'], int(tgt['image_id']))
            else:
                 savename = '{}/{}-{}.png'.format(savedir,tgt['image_name'], int(tgt['image_id']))
    ...
    def visualize2(self, img, tgt, caption=None, dpi=120, savedir=None, show_in_console=True,color='green'):
        """
        img: tensor(3, H, W)
        tgt: make sure they are all on cpu.
            must have items: 'image_id', 'boxes', 'size'
